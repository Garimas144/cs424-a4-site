// script.js - COMPLETE TASK 3 IMPLEMENTATION WITH BIDIRECTIONAL LINKING - FIXED
...
// =================================================================
// COMPLETE SPECIFICATION - WITH BIDIRECTIONAL INTERACTIONS - FIXED
// =================================================================
const completeSpec = {
    ...
    },
    {
      ...
      vconcat: [
        ...
        },
        {
          ...
          hconcat: [
            {
              // Geographic Distribution Map - FIXED TO HANDLE DATA MISMATCH
              title: {
              ...
              transform: [
                // CRITICAL FIX: Lookup to filter only schools in embedding
                {
                  lookup: "school",
                  from: {
                    data: { url: EMB_PATH },
                ...
                // Filter out schools not in embedding
                { filter: "datum.x != null" },
                // Apply embedding brush
                { filter: { param: "embedding_brush" } }
              ],
